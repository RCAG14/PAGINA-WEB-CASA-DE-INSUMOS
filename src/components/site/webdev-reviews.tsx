  ...
  return (
    ...
    >
      <ScrollReveal className="mx-auto flex max-w-4xl flex-col items-center gap-3 px-4 py-16 text-center sm:px-6">
        <span className="flex size-12 items-center justify-center rounded-xl border border-primary/30 bg-primary/5 text-primary shadow-glow-accent">
        ...
        <span className="w-fit rounded-full border border-dashed border-accent bg-accent/10 px-3 py-1.5 font-mono-technical text-[11px] uppercase tracking-wider text-primary">
