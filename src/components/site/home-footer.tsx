...
/**
 * Footer propio de la home ("/") — deliberadamente simple y separado del
 * SiteFooter que usa el flujo de compra (catálogo/carrito/checkout): sin
 * listado de clasificaciones, solo mapa + identidad + contacto directo.
 */
export async function HomeFooter({ logoUrl }: { logoUrl: string | null }) {
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-2 lg:items-center">
        ...
        <div className="flex flex-col items-start gap-5 lg:items-end lg:text-right">
          <div className="flex items-center gap-2.5">
            ...
            />
            <span className="font-heading text-xl font-bold tracking-tight">Casa Insumos</span>
          </div>
          <p className="max-w-md text-sm text-sidebar-foreground/70">{dict.footer.description}</p>
