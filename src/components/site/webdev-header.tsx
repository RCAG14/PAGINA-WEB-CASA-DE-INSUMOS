...
/**
 * Header propio de desarrollo-web — mismo patrón visual que HomeHeader y
 * CatalogHeader, pero su propio componente: cada mini-landing es
 * autocontenida y no comparte navbar con las demás. Sin carrito (no aplica
 * acá), con cuenta/login como en la home.
 */
